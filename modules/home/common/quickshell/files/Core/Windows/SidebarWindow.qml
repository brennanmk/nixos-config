...
PanelWindow {
    ...
    property int _screenHeight: screen ? screen.height : 1080
    property int _screenWidth: screen ? screen.width : 1920
    ...
    property int animationDuration: HyprlandService.enableAnimations ? Constants.animFast : 0

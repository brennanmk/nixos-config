...
RowLayout {
    ...
    SvgIcon {
        ...
        flat: true
        iconColor: root.sliderEnabled ? Theme.fg : Theme.muted
        bgColor: "transparent"
        visible: root.icon !== ""
    ...
    ThemedText {
        ...
        font.bold: true
        color: root.sliderEnabled ? Theme.fg : Theme.muted
        visible: root.label !== ""
    ...
    BaseSlider {
        ...
        value: root.value
        color: root.sliderEnabled ? Theme.accent : Theme.muted
    ...
    Rectangle {
        ...
        ThemedText {
            ...
            font.bold: true
            color: !root.sliderEnabled ? Theme.muted : Theme.fg

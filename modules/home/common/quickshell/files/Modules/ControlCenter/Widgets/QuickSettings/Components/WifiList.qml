...
Rectangle {
    ...
    Rectangle {
        ...
        ColumnLayout {
            anchors.centerIn: parent
            width: Math.min(parent.width - Constants.sizeLg * 2, 260)
            spacing: Constants.sizeSm
            ...
            ThemedTextField {
                ...
                onEditingFinished: connectButton.clicked()
            }

            ThemedText {
                visible: root.errorSsid === root.pendingSsid && root.errorText !== ""
                text: root.errorText
            ...
            RowLayout {
                ...
                ThemedButton {
                    ...
                    Layout.fillWidth: true
                    onClicked: {
                        root.connect(root.pendingSsid, pwField.text);
                        pwField.text = "";
                    }
                }
